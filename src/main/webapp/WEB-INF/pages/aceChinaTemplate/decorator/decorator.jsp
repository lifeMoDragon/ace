...
<html lang="zh-CN">
	<head>
		...
		<link rel="stylesheet" href="<%= basePath%>/pages/assets/css/bootstrap.min.css" />
		<link rel="stylesheet" href="<%= basePath%>/pages/assets/font-awesome/4.5.0/css/font-awesome.min.css" />

		<!-- 页面特定插件样式 -->

		<!-- 文本样式 -->
		<link rel="stylesheet" href="<%= basePath%>/pages/assets/css/fonts.googleapis.com.css" />

		<!-- ace样式 -->
		<link rel="stylesheet" href="<%= basePath%>/pages/assets/css/ace.min.css" class="ace-main-stylesheet" id="main-ace-style" />

		<!--[if lte IE 9]>
			<link rel="stylesheet" href="<%= basePath%>/pages/assets/css/ace-part2.min.css" class="ace-main-stylesheet" />
		<![endif]-->
		<link rel="stylesheet" href="<%= basePath%>/pages/assets/css/ace-skins.min.css" />
		<link rel="stylesheet" href="<%= basePath%>/pages/assets/css/ace-rtl.min.css" />

		<!--[if lte IE 9]>
		  <link rel="stylesheet" href="<%= basePath%>/pages/assets/css/ace-ie.min.css" />
		<![endif]-->

		<!-- 与此页相关的内联样式 -->

		<!-- ace配置处理 -->
		<script src="<%= basePath%>/pages/assets/js/ace-extra.min.js"></script>

		<!-- HTML5shiv and Respond.js 为IE8提供HTML5元素和媒体查询支持 -->

		<!--[if lte IE 8]>
		<script src="<%= basePath%>/pages/assets/js/html5shiv.min.js"></script>
		<script src="<%= basePath%>/pages/assets/js/respond.min.js"></script>
		<![endif]-->
		
		<script type="text/javascript">
			var path = '<%= path%>';/*完整路径 */
			var basePath = '<%= basePath%>';/*相对路径 */
		</script>
		<!-- basic scripts -->

		<!--[if !IE]> -->
		<script src="<%= basePath%>/pages/assets/js/jquery-2.1.4.min.js"></script>

		<!-- <![endif]-->

		<!--[if IE]>
<script src="<%= basePath%>/pages/assets/js/jquery-1.11.3.min.js"></script>
<![endif]-->
		<script type="text/javascript">
					...
					<ul class="nav ace-nav">
								...
								<li class="dropdown-content">
									<ul class="dropdown-menu dropdown-navbar" id="unCompleteTaskList">
										...
										<li>
											<a href="#">
												<div class="clearfix">
													<span class="pull-left">漏洞修复</span>
							...
							<ul class="dropdown-menu-right dropdown-navbar dropdown-menu dropdown-caret dropdown-close">
								...
								<li class="dropdown-content">
									<ul class="dropdown-menu dropdown-navbar" id="messageList">
										...
										<li>
											<a href="#" class="clearfix">
												<img src="<%= basePath%>/pages/assets/images/avatars/avatar3.png" class="msg-photo" alt="Susan's Avatar" />
												<span class="msg-body">
													<span class="msg-title">
										...
										<li>
											<a href="#" class="clearfix">
												<img src="<%= basePath%>/pages/assets/images/avatars/avatar4.png" class="msg-photo" alt="Bob's Avatar" />
												<span class="msg-body">
													<span class="msg-title">
										...
										<li>
											<a href="#" class="clearfix">
												<img src="<%= basePath%>/pages/assets/images/avatars/avatar2.png" class="msg-photo" alt="Kate's Avatar" />
												<span class="msg-body">
													<span class="msg-title">
										...
										<li>
											<a href="#" class="clearfix">
												<img src="<%= basePath%>/pages/assets/images/avatars/avatar5.png" class="msg-photo" alt="Fred's Avatar" />
												<span class="msg-body">
													<span class="msg-title">
						...
						<li class="light-blue dropdown-modal">
							<a data-toggle="dropdown" href="#" class="dropdown-toggle">
								<img class="nav-user-photo" src="<%= basePath%>/pages/assets/images/avatars/user.jpg" alt="Jason's Photo" />
				...
				<ul class="nav nav-list">
					<li class="active">
						<a href="index.html">
							...
							<span class="menu-text"> 仪表面板 </span>
						</a>
